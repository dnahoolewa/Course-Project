...
Step 4: Copy the ***run_analysis.R*** scriptfile to the folder that contains the ***README.txt*** file that was included in the downloaded data-set
...
y		2
	...
	A unique identifier for the activity performed.
		1: 
		2:
		3:
		4:
...
activity	10
	...
	A character string that describes the activity performed.
